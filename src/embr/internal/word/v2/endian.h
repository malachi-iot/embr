...
using map_to_endian = estd::integral_constant<
    estd::endian,
    !is_set(o & v2::word_options::endian_mask) ? estd::endian::native :
        is_set(o & v2::word_options::big_endian) ? estd::endian::big : estd::endian::little>;


template <v2::word_options o>
using is_native_endian = estd::bool_constant<
    (!is_set(o & v2::word_options::endian_mask) ||
