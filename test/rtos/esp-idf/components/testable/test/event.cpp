...
EMBR_ESP_EVENT_DECLARE_BASE_EXP2(test, SYNTHETIC4_EVENTS);
EMBR_ESP_EVENT_TRAITS_EXP2(test::SYNTHETIC4_EVENT_2, int);
//EMBR_ESP_EVENT_DECLARE_BASE_EXP2(, SYNTHETIC_EVENTS5);
...
EMBR_ESP_EVENT_DECLARE_BASE_EXP2(SYNTHETIC_EVENTS3);
